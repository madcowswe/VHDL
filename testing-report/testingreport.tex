...
%TODO write about anything that could be missed by pure coverage, to at least show that we understand that 100% doesn't mean a working design. But it is a good indicator as it shows that all code paths have been exercised.
